...
export const hubs = [
  ...
  },
  {
    ...
    description: "Review all three credit reports, dispute errors, understand score factors and use freezes to protect access to your files.",
...
export const newArticles = [
  ...
  },
  {
    ...
    sections: [
      ...
      ["Use two calculations", `<p>Calculate lender-style DTI, then build a separate cash-flow test using take-home income and all essential expenses. If the proposed payment works in one calculation but not the other, the household budget is the more important warning.</p><p>Stress-test the cash-flow version with a realistic increase in insurance, utilities or another variable cost. Also test a month with lower overtime, commission or self-employment income. These scenarios do not change the lender formula, but they show whether the payment leaves enough room for ordinary volatility.</p>`],
      ["Prepare a lender-ready record", `<p>List each debt with the creditor, current balance, required monthly payment and the statement date. For credit cards, use the required payment shown on a recent statement rather than dividing the balance by an assumed term. For installment loans, confirm whether a payment will end before the proposed loan closes because underwriting treatment can depend on the remaining term and lender rules.</p><p>Income documentation also matters. Salaried income may be straightforward, while bonuses, overtime, commissions, rental income or self-employment earnings can require a longer record and adjustments. Do not treat a personal calculation as an approval estimate: the lender will verify documents and apply its own product rules.</p><ul class="checklist"><li>Use recent statements and pay records.</li><li>Calculate current DTI before adding a proposed payment.</li><li>Calculate the ratio again with the proposed payment included.</li><li>Compare both results with a full take-home cash-flow budget.</li><li>Keep an emergency reserve outside the down payment or loan proceeds.</li></ul>`]
    ],
    faqs: [
  ...
  },
  {
    ...
    sections: [
      ...
      ["Normalize offers before choosing", `<p>Start with the amount of cash the household actually needs. If one lender deducts a fee, its face amount may need to be larger to deliver the same net proceeds as a no-fee offer. Then compare offers using the same repayment term. Otherwise, a longer loan can appear cheaper because of the lower payment while producing a larger total repayment.</p><div class="table-scroll"><table><thead><tr><th>Worksheet line</th><th>Offer A</th><th>Offer B</th></tr></thead><tbody><tr><td>Cash delivered</td><td>From disclosure</td><td>From disclosure</td></tr><tr><td>APR and term</td><td>Same term where possible</td><td>Same term where possible</td></tr><tr><td>Monthly payment</td><td>Required amount</td><td>Required amount</td></tr><tr><td>Total of payments</td><td>Full scheduled total</td><td>Full scheduled total</td></tr><tr><td>Optional products</td><td>Price separately</td><td>Price separately</td></tr></tbody></table></div><p>Save the final disclosure, not only a prequalification screen. A prequalified estimate can change after identity, income, employment, debt and credit information are verified. Before accepting, confirm the lender’s legal name, contact information, complaint channels, payment schedule, late terms and whether automatic payment is required for any quoted discount.</p>`]
    ],
    faqs: [
  ...
  },
  {
    ...
    sections: [
      ...
      ["Model the deductible before a claim", `<p>Compare the deductible with the household’s available cash, not only with the vehicle’s value. If a $1,000 deductible would require a credit-card balance after a covered loss, the premium saving may be transferring risk into more expensive debt. Keep the selected amount in accessible savings and remember that separate deductibles can apply to collision and comprehensive claims.</p><p>A deductible also does not define the maximum claim cost. A policy can apply limits, exclusions, valuation rules, betterment or depreciation provisions, and the insurer may determine that repair cost exceeds the vehicle’s actual cash value. Ask how original-equipment and aftermarket parts, rental reimbursement, towing and glass claims are handled.</p><p>For each quote, save the declarations-style summary and record the quote date, policy term, payment-plan fees and discounts. Confirm that telematics, bundling, defensive-driving or low-mileage discounts have the same assumptions. A quote with an introductory or conditional discount is not directly comparable with one that shows the full ongoing premium.</p>`]
    ],
    faqs: [
  ...
  },
  {
    ...
    sections: [
      ...
      ["Turn the inventory into coverage decisions", `<p>Add the replacement price of ordinary belongings before choosing a personal-property limit. Clothing, kitchen equipment and basic furniture are easy to underestimate when considered one item at a time. Then separate property subject to special sublimits, such as jewelry, collectibles, money, certain electronics or business equipment. Ask whether scheduled coverage or another endorsement is available when the standard sublimit is not enough.</p><p>Review liability separately from property. A guest injury, accidental damage claim or covered incident away from the apartment may involve defense costs and a policy limit that has little connection to the value of your belongings. Confirm who is an insured, whether a roommate must be named, and how pets, home-based work or short-term rental activity affect coverage.</p><p>For loss of use, ask which additional expenses qualify, how long payments can continue and whether the loss must result from a covered cause. Keep lease records, receipts and a secure copy of the policy outside the home. After a move or major purchase, update the inventory, address and coverage limits instead of waiting for the next claim.</p>`]
    ],
    faqs: [
  ...
  },
  {
    ...
    description: "Compare traditional and Roth IRAs by tax deductions, eligibility, withdrawal rules, required distributions and retirement tax timing.",
    readTime: 9,
    takeaways: [
    ...
    sections: [
      ...
      ["Separate contributions, conversions and withdrawals", `<p>A regular contribution adds new money and is limited by the annual IRA contribution rules. A Roth conversion moves eligible pre-tax retirement money into Roth treatment and can create taxable income for the conversion year. A rollover generally moves retirement assets between eligible accounts under a different set of rules. These actions are not interchangeable, so identify the transaction before applying a limit or tax assumption.</p><p>Withdrawal treatment also depends on the source of money and timing. Traditional IRA distributions are generally included in taxable income except for any properly documented after-tax basis. Roth IRA withdrawal rules distinguish regular contributions, conversion amounts and earnings, while qualified-distribution requirements affect whether earnings are tax-free. Early-distribution taxes and exceptions can apply differently from ordinary income-tax treatment.</p><p>Keep Form 8606 and other tax records when nondeductible contributions or conversions are involved. A custodian reports transactions but does not determine every tax consequence for the household. Before a conversion or withdrawal, estimate the effect on federal and state taxable income, credits, Medicare premiums and cash available to pay tax rather than withholding unexpectedly from retirement assets.</p>`]
    ],
    faqs: [
